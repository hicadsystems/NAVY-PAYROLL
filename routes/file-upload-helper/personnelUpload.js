  ...
  try {
    ...
    headers.forEach((header, index) => {
      ...
      cell.fill = {
        type: 'pattern',
        pattern: 'solid',
        fgColor: { argb: 'FF2E5C8A' } // Darker blue (similar to your image)
      };
      cell.border = {
    ...
    const instructions = [
      ...
      '7. All fields are required unless specified as optional',
